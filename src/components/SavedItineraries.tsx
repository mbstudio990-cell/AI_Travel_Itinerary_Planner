      ...
      {itineraries.length === 0 ? (
        ...
        <div className="grid gap-6 sm:gap-8">
          {itineraries.map((itinerary) => (
            <div key={itinerary.id} className="bg-white rounded-lg sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8 max-w-6xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start justify-between space-y-4 sm:space-y-0">
                <div className="flex-1 pr-0 sm:pr-6">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                      <span className="text-sm sm:text-base bg-blue-100 text-blue-700 px-3 py-2 rounded-lg font-medium">
                        {itinerary.days.length} days
                      </span>
                      <span className="text-sm sm:text-base bg-green-100 text-green-700 px-3 py-2 rounded-lg font-medium">
                        {itinerary.preferences.budget}
                      </span>
                  </div>

                  <p className="text-gray-600 text-sm sm:text-base mb-4 break-words leading-relaxed">
                ...
                <div className="flex flex-col space-y-3 w-full sm:w-auto sm:min-w-[120px]">
                  <button
                    onClick={() => onView(itinerary)}
                    className="flex items-center justify-center space-x-2 px-4 sm:px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm sm:text-base font-medium shadow-sm hover:shadow-md"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center space-x-2 px-4 sm:px-6 py-3 border border-red-300 hover:bg-red-50 text-red-600 rounded-lg transition-colors text-sm sm:text-base font-medium shadow-sm hover:shadow-md"
                  >
